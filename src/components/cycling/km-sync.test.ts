...
describe('computeGearKmFromActivities', () => {
  ...
  it('sums matching activities strictly after the cutoff date', () => {
    const activities = [
      { gear_id: gearId, start_date_local: '2026-08-20T10:00:00', distance: 40000 }, // before cutoff, excluded
      { gear_id: gearId, start_date_local: '2026-08-23T10:00:00', distance: 40000 }, // == cutoff, excluded
      { gear_id: gearId, start_date_local: '2026-08-24T10:00:00', distance: 30000 }, // after cutoff, included
      { gear_id: gearId, start_date_local: '2026-08-25T10:00:00', distance: 20000 }, // after cutoff, included
    ]
  ...
  it('ignores activities tagged with a different gear', () => {
    const activities = [
      { gear_id: 'other-bike', start_date_local: '2026-08-24T10:00:00', distance: 50000 },
      { gear_id: gearId, start_date_local: '2026-08-24T10:00:00', distance: 10000 },
    ]
  ...
  it('sums everything in the window on a first-ever sync (no cutoff)', () => {
    const activities = [
      { gear_id: gearId, start_date_local: '2026-06-01T10:00:00', distance: 100000 },
      { gear_id: gearId, start_date_local: '2026-08-24T10:00:00', distance: 25000 },
    ]
  ...
  it('ignores activities with no distance or zero distance', () => {
    const activities = [
      { gear_id: gearId, start_date_local: '2026-08-24T10:00:00' },
      { gear_id: gearId, start_date_local: '2026-08-24T10:00:00', distance: 0 },
    ]
  ...
  it("doesn't depend on any gear rollup field — only ever reads activities", () => {
    ...
    const activities = [{ gear_id: gearId, start_date_local: '2026-08-24T10:00:00', distance: 45000 }]
