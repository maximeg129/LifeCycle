...
export function useTrainingPlan() {
   ...
   */
  // Extrait dans use-generate-week-sessions.ts pour être réutilisable par
  // use-daily-workout.ts aussi (voir son propre commentaire pour le
  // pourquoi — corrige une régression de la séparation Aujourd'hui/Plan).
